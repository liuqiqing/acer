...
/*
    public List<Map<String, Object>> getckxxqk(String Cdate, String page);
*/



    public List<Map<String, Object>> getckxxqk(@RequestParam(value = "year", required = true) String year,
                                               @RequestParam(value = "month", required = true) String month,
                                               @RequestParam(value = "day", required = true) String day,
